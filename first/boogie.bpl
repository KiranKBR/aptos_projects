...
// struct string::String at /home/kiran/.move/https___github_com_aptos-labs_aptos-core_git_mainnet/aptos-move/framework/aptos-framework/../aptos-stdlib/../move-stdlib/sources/string.move:13:5+70
...
// spec fun at /home/kiran/.move/https___github_com_aptos-labs_aptos-core_git_mainnet/aptos-move/framework/aptos-framework/../aptos-stdlib/sources/string_utils.spec.move:54:10+120
...
// fun string_utils::debug_string<u64> [baseline] at /home/kiran/.move/https___github_com_aptos-labs_aptos-core_git_mainnet/aptos-move/framework/aptos-framework/../aptos-stdlib/sources/string_utils.move:34:5+101
procedure {:inline 1} $1_string_utils_debug_string'u64'(_$t0: int) returns ($ret0: $1_string_String)
{
    ...
    // trace_local[s]($t0) at /home/kiran/.move/https___github_com_aptos-labs_aptos-core_git_mainnet/aptos-move/framework/aptos-framework/../aptos-stdlib/sources/string_utils.move:34:5+1
    assume {:print "$at(73,1620,1621)"} true;
    assume {:print "$track_local(3,1,0):", $t0} $t0 == $t0;

    // $t1 := true at /home/kiran/.move/https___github_com_aptos-labs_aptos-core_git_mainnet/aptos-move/framework/aptos-framework/../aptos-stdlib/sources/string_utils.move:35:26+4
    assume {:print "$at(73,1689,1693)"} true;
    $t1 := true;
    assume $IsValid'bool'($t1);

    // $t2 := false at /home/kiran/.move/https___github_com_aptos-labs_aptos-core_git_mainnet/aptos-move/framework/aptos-framework/../aptos-stdlib/sources/string_utils.move:35:32+5
    $t2 := false;
    assume $IsValid'bool'($t2);

    // $t3 := false at /home/kiran/.move/https___github_com_aptos-labs_aptos-core_git_mainnet/aptos-move/framework/aptos-framework/../aptos-stdlib/sources/string_utils.move:35:39+5
    $t3 := false;
    assume $IsValid'bool'($t3);

    // $t4 := false at /home/kiran/.move/https___github_com_aptos-labs_aptos-core_git_mainnet/aptos-move/framework/aptos-framework/../aptos-stdlib/sources/string_utils.move:35:46+5
    $t4 := false;
    assume $IsValid'bool'($t4);

    // $t5 := opaque begin: string_utils::native_format<#0>($t0, $t1, $t2, $t3, $t4) at /home/kiran/.move/https___github_com_aptos-labs_aptos-core_git_mainnet/aptos-move/framework/aptos-framework/../aptos-stdlib/sources/string_utils.move:35:9+43

    // assume WellFormed($t5) at /home/kiran/.move/https___github_com_aptos-labs_aptos-core_git_mainnet/aptos-move/framework/aptos-framework/../aptos-stdlib/sources/string_utils.move:35:9+43
    assume $IsValid'$1_string_String'($t5);

    // assume Eq<string::String>($t5, string_utils::spec_native_format<#0>($t0, $t1, $t2, $t3, $t4)) at /home/kiran/.move/https___github_com_aptos-labs_aptos-core_git_mainnet/aptos-move/framework/aptos-framework/../aptos-stdlib/sources/string_utils.move:35:9+43
    assume $IsEqual'$1_string_String'($t5, $1_string_utils_spec_native_format'u64'($t0, $t1, $t2, $t3, $t4));

    // $t5 := opaque end: string_utils::native_format<#0>($t0, $t1, $t2, $t3, $t4) at /home/kiran/.move/https___github_com_aptos-labs_aptos-core_git_mainnet/aptos-move/framework/aptos-framework/../aptos-stdlib/sources/string_utils.move:35:9+43

    // trace_return[0]($t5) at /home/kiran/.move/https___github_com_aptos-labs_aptos-core_git_mainnet/aptos-move/framework/aptos-framework/../aptos-stdlib/sources/string_utils.move:35:9+43
    assume {:print "$track_return(3,1,0):", $t5} $t5 == $t5;

    // label L1 at /home/kiran/.move/https___github_com_aptos-labs_aptos-core_git_mainnet/aptos-move/framework/aptos-framework/../aptos-stdlib/sources/string_utils.move:36:5+1
    assume {:print "$at(73,1720,1721)"} true;
L1:

    // return $t5 at /home/kiran/.move/https___github_com_aptos-labs_aptos-core_git_mainnet/aptos-move/framework/aptos-framework/../aptos-stdlib/sources/string_utils.move:36:5+1
    assume {:print "$at(73,1720,1721)"} true;
    $ret0 := $t5;
    return;
...
// fun debug::print<u64> [baseline] at /home/kiran/.move/https___github_com_aptos-labs_aptos-core_git_mainnet/aptos-move/framework/aptos-framework/../aptos-stdlib/sources/debug.move:5:5+67
procedure {:inline 1} $1_debug_print'u64'(_$t0: int) returns ()
{
    ...
    // bytecode translation starts here
    // trace_local[x]($t0) at /home/kiran/.move/https___github_com_aptos-labs_aptos-core_git_mainnet/aptos-move/framework/aptos-framework/../aptos-stdlib/sources/debug.move:5:5+1
    assume {:print "$at(54,102,103)"} true;
    assume {:print "$track_local(4,2,0):", $t0} $t0 == $t0;

    // $t1 := string_utils::debug_string<#0>($t0) on_abort goto L2 with $t2 at /home/kiran/.move/https___github_com_aptos-labs_aptos-core_git_mainnet/aptos-move/framework/aptos-framework/../aptos-stdlib/sources/debug.move:14:9+40
    ...
    // opaque begin: debug::native_print($t1) at /home/kiran/.move/https___github_com_aptos-labs_aptos-core_git_mainnet/aptos-move/framework/aptos-framework/../aptos-stdlib/sources/debug.move:6:9+23
    assume {:print "$at(54,139,162)"} true;

    // opaque end: debug::native_print($t1) at /home/kiran/.move/https___github_com_aptos-labs_aptos-core_git_mainnet/aptos-move/framework/aptos-framework/../aptos-stdlib/sources/debug.move:6:9+23

    // label L1 at /home/kiran/.move/https___github_com_aptos-labs_aptos-core_git_mainnet/aptos-move/framework/aptos-framework/../aptos-stdlib/sources/debug.move:7:5+1
    assume {:print "$at(54,168,169)"} true;
L1:

    // return () at /home/kiran/.move/https___github_com_aptos-labs_aptos-core_git_mainnet/aptos-move/framework/aptos-framework/../aptos-stdlib/sources/debug.move:7:5+1
    assume {:print "$at(54,168,169)"} true;
    return;

    // label L2 at /home/kiran/.move/https___github_com_aptos-labs_aptos-core_git_mainnet/aptos-move/framework/aptos-framework/../aptos-stdlib/sources/debug.move:7:5+1
L2:

    // abort($t2) at /home/kiran/.move/https___github_com_aptos-labs_aptos-core_git_mainnet/aptos-move/framework/aptos-framework/../aptos-stdlib/sources/debug.move:7:5+1
    assume {:print "$at(54,168,169)"} true;
    $abort_code := $t2;
    $abort_flag := true;
    return;
...
// fun Sample::sample_function [verification] at /home/kiran/Desktop/Blockchain/aptos/first/sources/first.move:5:5+63
procedure {:timeLimit 40} $42_Sample_sample_function$verify() returns ()
{
    ...
    // bytecode translation starts here
    // $t1 := 12345 at /home/kiran/Desktop/Blockchain/aptos/first/sources/first.move:7:23+5
    assume {:print "$at(2,101,106)"} true;
    $t1 := 12345;
    assume $IsValid'u64'($t1);

    // debug::print<u64>($t1) on_abort goto L2 with $t2 at /home/kiran/Desktop/Blockchain/aptos/first/sources/first.move:7:9+20
    ...
    // label L1 at /home/kiran/Desktop/Blockchain/aptos/first/sources/first.move:8:5+1
    assume {:print "$at(2,113,114)"} true;
L1:

    // return () at /home/kiran/Desktop/Blockchain/aptos/first/sources/first.move:8:5+1
    assume {:print "$at(2,113,114)"} true;
    return;

    // label L2 at /home/kiran/Desktop/Blockchain/aptos/first/sources/first.move:8:5+1
L2:

    // abort($t2) at /home/kiran/Desktop/Blockchain/aptos/first/sources/first.move:8:5+1
    assume {:print "$at(2,113,114)"} true;
    $abort_code := $t2;
    $abort_flag := true;
    return;
